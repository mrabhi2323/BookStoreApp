...
function Navbar() {
  ...
  return (
    ...
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50
          ${sticky?"sticky-navbar shadow-d bg-base-200 dark:bg-slate-800 dark:text-white duration-300 transition-all ease-in-out" :"" }`}>
...
{/* Login logout Button */}
{
  authUser? <Logout/> :
  <div  className="">
    <a className=" cursor-pointer bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300"
