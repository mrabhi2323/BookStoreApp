    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        ...
        {/* text part heading + paragraph */}
            <div className="space-y-12">
                ...
                <p className="text-xl">
                A cozy retreat for book lovers and curious minds! 
                Our shelves are filled with a diverse selection of books, 
                from bestsellers to timeless classics. 
                we're here to help you on your literary journey. Happy reading!
                </p>
        {/* email input */}
